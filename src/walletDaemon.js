...
module.exports = class walletNode extends EventEmitter {
  constructor (nodeAddress, readyCallback) {
    ...
    const packageDefinition = protoLoader.loadSync(__dirname + '/../protos/anumawalletd.proto', {
      keepCase: true,
      longs: String,
      enums: String,
      defaults: true,
      oneofs: true
		...
		const { anumawalletd } = gRPC.loadPackageDefinition(packageDefinition).anumawalletd

    this._client = new anumawalletd(nodeAddress, gRPC.credentials.createInsecure(), {  
